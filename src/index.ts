...
const THEME_ORDER = ["rose-pine", "vesper", "catppuccin", "noir"];
...
function renderWPMGraph(samples: number[]): string {
...
async function createApp() {
  ...
  const getTheme = (): Theme => THEMES[THEME_ORDER[state.currentThemeIndex]];
